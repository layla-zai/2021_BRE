...
```{r}
# If you don't know where you are, you can use getwd() to get the file path or
...
# ../ = the directory above my directory
# can specify the relative file path to write to a different directory
write_tsv(measles, '../measles.tsv')
write_tsv(measles, 'subdirectory/measles.tsv')
...
`separate()` also lets you specify an integer position to split at
...
# join by all clumns with same name
